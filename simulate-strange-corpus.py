...
language.loc[language['word'] == 'president', 'freq'] = 1000
...
with open('/home/lacnsg/sopsla/Documents/code-repositories/surprisal-simulations/strange-corpus.txt', 'w') as f:
    f.write('\n'.join(corpus))